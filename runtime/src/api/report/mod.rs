...
use crate::api::report::{
    create::report_create_route, list::report_index_route, pin::report_pin_route, read::report_read_route, view::report_view_route
};
mod create;
mod list;
mod pin;
...
pub fn report_routes() -> Router {
    Router::new()
        ...
        .route("/pin", routing::get(report_pin_route))
